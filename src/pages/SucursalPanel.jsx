...
const SucursalPanel = ({ selectedSucursal }) => {
  ...
  return (
    <div className="container mx-auto p-3" style={{ color: theme.textColor, backgroundColor: theme.backgroundColor }}>
      ...
      <div className="flex space-x-2 mb-3">
        <Link
          ...
          style={{
            color: location.pathname.includes("almacenes") ? theme.textColor : theme.primaryColor,
            backgroundColor: location.pathname.includes("almacenes") ? theme.primaryColor : theme.backgroundColor,
          }}
        >
          Almacenes
        </Link>
        <Link
          ...
          style={{
            color: location.pathname.includes("cajas") ? theme.textColor : theme.primaryColor,
            backgroundColor: location.pathname.includes("cajas") ? theme.primaryColor : theme.backgroundColor,
          }}
        >
          Cajas
        </Link>
        <Link
          ...
          style={{
            color: location.pathname.includes("ventas") ? theme.textColor : theme.primaryColor,
            backgroundColor: location.pathname.includes("ventas") ? theme.primaryColor : theme.backgroundColor,
          }}
        >
          Ventas
        </Link>
        <Link
          ...
          style={{
            color: location.pathname.includes("reportes") ? theme.textColor : theme.primaryColor,
            backgroundColor: location.pathname.includes("reportes") ? theme.primaryColor : theme.backgroundColor,
          }}
        >
          Reportes
        </Link>
